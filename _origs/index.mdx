...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/index.md" icon={icon1} header="Tutorials">
        Our Great Tutorials in one place.
    </ThinTile>
    <ThinTile to="developer-portal/index.md" icon={launchFastIcon} header="Onboarding">
        All aboard!.
    </ThinTile>
    <ThinTile to="contact.mdx" icon={icon3} header="Resources">
